...
const About = () => {
  return (
    <section id="about" className="min-h-screen  pt-30 py-16 px-4 sm:px-6 lg:px-12 xl:px-20 bg-gradient-to-br from-indigo-50 via-purple-50 to-white">
      {/* Section Heading */}
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-[1.6fr_1fr] gap-12 items-center">
        ...
        >
          <p>
            Hello! I’m{" "}
 <span className="font-semibold text-indigo-700">Monika Senger</span>, an MCA graduate (final exams completed, result awaited) from the Institute of Management and Technology, MDU. I’m passionate about building real-world tech solutions and currently focusing on{" "}
 <span className="text-purple-600 font-medium">Full-Stack Development</span> — Java, Spring Boot, React.js, MongoDB & MySQL.
    ...
    – Next.js + MongoDB with charts & monthly expense tracking
  </li>
            <li>
              <span className="text-indigo-700 font-medium">
