...
const Skills = () => {
  ...
  const categorizedTechSkills = [
    ...
    },
    {
      ...
      data: technicalSkills.filter((s) =>
        ["React.js", "Spring Boot", "Java Swing","Next.js","Recharts","shadcn/ui"].includes(s.name)
      ),
    },
    {
    ...
    },
    {
      ...
      data: technicalSkills.filter((s) =>
        ["Git", "GitHub", "Render","Vercel"].includes(s.name)
      ),
    },
  ];
  ...
  return (
    <section id="skills" className="min-h-screen py-16 px-6  pt-30 bg-gradient-to-br from-white via-purple-50 to-indigo-100">
